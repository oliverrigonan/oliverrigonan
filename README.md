...
As a Senior Software Engineer and Full Stack Developer, I specialize in blockchain development using Rust, focusing on building custom pallets with the Substrate framework and developing Ink! smart contracts for the Xode Blockchain within the Polkadot ecosystem. I also contribute to the development of the Xterium Wallet, enabling seamless blockchain interactions across mobile, web, and browser platforms.

Passionate about technology and innovation, I enjoy collaborating with others to create impactful solutions that drive the future of decentralized applications.
